# ============================================================
# fix-tokkipass-types.ps1
# Perbaikan untuk error:
# "Property 'tier' does not exist on type 'never'"
#
# Penyebab: tipe Database kurang lengkap (Views/Functions/
# CompositeTypes hilang) sehingga Supabase client gagal infer
# tipe hasil query. Sekalian nambahin tabel payment_orders yang
# kepake di actions/create-snap-token.ts tapi belum ada di tipe.
#
# CARA PAKAI:
# 1. cd C:\Users\abdul\Documents\Menkyo\tokkipass
# 2. powershell -ExecutionPolicy Bypass -File fix-tokkipass-types.ps1
# ============================================================

Write-Host "Memperbaiki types/database.types.ts..." -ForegroundColor Cyan
...
Write-Host "  - types/database.types.ts FIXED" -ForegroundColor Green
Write-Host ""
Write-Host "Selesai. Lanjut jalankan: npm run build" -ForegroundColor Yellow
